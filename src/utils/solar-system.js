...
export const createSelectiveUnrealBloomComposer = ({ renderer, scene, camera }) => {
  const bloomComposer = new EffectComposer(renderer);
  window.addEventListener('resize', () => bloomComposer.setSize(window.innerWidth, window.innerHeight));
  ...
  window.addEventListener('resize', () => finalComposer.setSize(window.innerWidth, window.innerHeight));
